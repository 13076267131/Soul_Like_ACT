...
#define UE_PROJECT_NAME Soul_Like_ACT
#define UE_TARGET_NAME Soul_Like_ACTEditor
...
#define INPUTBUFFEREDITOR_API DLLEXPORT
#define INPUTBUFFER_API DLLIMPORT
