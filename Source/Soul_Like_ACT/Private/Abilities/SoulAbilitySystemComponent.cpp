...
bool USoulAbilitySystemComponent::TryActivateAbilityByClassWithDelegate(TSubclassOf<UGameplayAbility> InAbilityToActivate, FOnGameplayAbilityEnded::FDelegate* OnGameplayAbilityEndedDelegate /*= nullptr*/)
{
	bool bSuccess = false;
...
bool USoulAbilitySystemComponent::TryActivateAbilityWithDelegate(FGameplayAbilitySpecHandle AbilityToActivate, bool bAllowRemoteActivation, FOnGameplayAbilityEnded::FDelegate* OnGameplayAbilityEndedDelegate /*= nullptr*/)
{
