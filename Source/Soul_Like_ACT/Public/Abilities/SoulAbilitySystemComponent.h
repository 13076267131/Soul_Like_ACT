...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static FActiveGameplayEffectHandle ApplyGE_ToSelf(const AActor* Actor,
                                                      const TSubclassOf<UGameplayEffect> GameplayEffect,
                                                      const int32 AbilityLevel);

    UFUNCTION(BlueprintCallable)
    static FActiveGameplayEffectHandle ApplyGE_ToTarget(const AActor* FromActor, const AActor* TargetActor,
                                                        const TSubclassOf<UGameplayEffect> GameplayEffect,
                                                        const int32 AbilityLevel);
